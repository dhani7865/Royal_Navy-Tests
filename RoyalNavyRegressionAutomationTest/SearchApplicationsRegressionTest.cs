...
namespace ROYAL_NAVY_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class SearchApplicationsRegressionTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Royal Navy Search Applications Button Regression Test 29-11-2022.html";
        ...
        [TestMethod]
        public void test_SearchApplicationsRegressionTest()
        {

            ExtentStart();
            var test = extent.CreateTest("Royal Navy - Search Applications Regression Test").Info("Test Started");
            ...
            wait.Until(ExpectedConditions.ElementToBeClickable(By.CssSelector("li:nth-child(6) img"))).Click();
            ...
            selectElement.SelectByText("RitsLinkSent");
