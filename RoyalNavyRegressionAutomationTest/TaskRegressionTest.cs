...
namespace ROYAL_NAVY_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class TaskRegressionTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Royal Navy Task Button Regression Test 29-11-2022.html";
        ...
        [TestMethod]
        public void test_TaskRegressionTest()
        {

            ExtentStart();
            var test = extent.CreateTest("Royal Navy - Task Regression Test").Info("Test Started");
