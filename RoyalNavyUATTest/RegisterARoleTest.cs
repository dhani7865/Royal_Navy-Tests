...
namespace ROYAL_NAVY_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class RegisterARoleTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Royal NAVY Register A Role Test 30-11-2022.html";
        ...
        [TestMethod]
        public void test_RegisterARoleTest()
        {

            ExtentStart();
            var test = extent.CreateTest("Royal Navy - Register A Role Test").Info("Test Started");
            ...
            // Test 3
            // Clicking on the I'm interested in a specific role button
            wait.Until(ExpectedConditions.ElementIsVisible(By.CssSelector("#careerssections_0_pnlTypeOfRequest .form__field:nth-child(1) > label"))).Click();

            // driver.FindElement(By.CssSelector("#careerssections_0_pnlTypeOfRequest .form__field:nth-child(1) > label")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(5000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Clicking on the I'm interested in a specific role button");
            ...
            // Test 6
            // Clicking the ready to apply button and clicking the ok button
            driver.FindElement(By.CssSelector(".form__row--reducedmargin > .has-tooltip:nth-child(1) > label")).Click();
            driver.FindElement(By.CssSelector(".form-field-selected__link:nth-child(3)")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(5000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Clicking the ready to apply button and clicking the ok button");
            ...
            driver.FindElement(By.Id("careerssections_0_txtFirstName")).SendKeys("Aircrew Officer Pilot");
            ...
            driver.FindElement(By.Id("careerssections_0_txtSurname")).SendKeys("Third");
            ...
            driver.FindElement(By.Id("careerssections_0_txtDOB")).SendKeys("02/02/2000");
            ...
            // driver.FindElement(By.CssSelector(".form__set:nth-child(4) > .form__row:nth-child(7) > .form__field")).Click();
            ...
            // Test 18
            // Selecting Male for the DIVERSITY
            // driver.FindElement(By.CssSelector(".form__set:nth-child(6) .form__field:nth-child(2) > label")).Click();
            ...
            System.Threading.Thread.Sleep(5000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Selecting Male for the DIVERSITY");
            ...
            driver.FindElement(By.CssSelector("#careerssections_0_ddlEthnicity_chosen .active-result:nth-child(3)")).Click();
