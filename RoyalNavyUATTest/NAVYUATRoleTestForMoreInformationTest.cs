...
namespace ROYAL_NAVY_SELENIUM_TESTS
{
    ...
    [TestClass]
    public class NAVYUATRoleTestForMoreInformationTest
    {
        ...
        public static void ExtentStart()
        {
            ...
            string reportPath = projectPath + "TestReport\\Royal NAVY UAT Role Test For More Information Test 30-11-2022.html";
        ...
        [TestMethod]
        public void test_NAVYUATRoleTestForMoreInformationTest()
        {

            ExtentStart();
            var test = extent.CreateTest("Royal Navy - UAT Role Test For More Information Test").Info("Test Started");
            ...
            // Test 6
            // Clicking No For More Information About The Role Button and clicking the ok button
            driver.FindElement(By.CssSelector(".form__row--reducedmargin > .has-tooltip:nth-child(2) > label")).Click();
            driver.FindElement(By.CssSelector(".form-field-selected__link:nth-child(4)")).Click();

            // 5 seconds implicit wait (C# code)
            System.Threading.Thread.Sleep(5000);
            // Logging the test in the extent report and pass status
            test.Log(Status.Info, "Clicking No For More Information About The Role Button and clicking the ok button");
            ...
            driver.FindElement(By.Id("careerssections_0_txtFirstName")).SendKeys("RFP OneA");
            ...
            driver.FindElement(By.Id("careerssections_0_txtSurname")).SendKeys("Air Engineer Officer Two");
